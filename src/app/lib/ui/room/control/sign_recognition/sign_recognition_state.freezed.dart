...
mixin _$SignRecognitionState {
 ...
 LocalTrackPublication<LocalVideoTrack>? get selectedVideoPublication; bool get shouldNotifyNoVideoTrack; SessionState get sessionState; bool get isLoading; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,selectedVideoPublication,shouldNotifyNoVideoTrack,sessionState,isLoading,errorMessage);

@override
String toString() {
  return 'SignRecognitionState(selectedVideoPublication: $selectedVideoPublication, shouldNotifyNoVideoTrack: $shouldNotifyNoVideoTrack, sessionState: $sessionState, isLoading: $isLoading, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 LocalTrackPublication<LocalVideoTrack>? selectedVideoPublication, bool shouldNotifyNoVideoTrack, SessionState sessionState, bool isLoading, String? errorMessage
});
...
/// Create a copy of SignRecognitionState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedVideoPublication = freezed,Object? shouldNotifyNoVideoTrack = null,Object? sessionState = null,Object? isLoading = null,Object? errorMessage = freezed,}) {
...
as bool,sessionState: null == sessionState ? _self.sessionState : sessionState // ignore: cast_nullable_to_non_nullable
as SessionState,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LocalTrackPublication<LocalVideoTrack>? selectedVideoPublication,  bool shouldNotifyNoVideoTrack,  SessionState sessionState,  bool isLoading,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignRecognitionState() when $default != null:
return $default(_that.selectedVideoPublication,_that.shouldNotifyNoVideoTrack,_that.sessionState,_that.isLoading,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LocalTrackPublication<LocalVideoTrack>? selectedVideoPublication,  bool shouldNotifyNoVideoTrack,  SessionState sessionState,  bool isLoading,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _SignRecognitionState():
return $default(_that.selectedVideoPublication,_that.shouldNotifyNoVideoTrack,_that.sessionState,_that.isLoading,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LocalTrackPublication<LocalVideoTrack>? selectedVideoPublication,  bool shouldNotifyNoVideoTrack,  SessionState sessionState,  bool isLoading,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _SignRecognitionState() when $default != null:
return $default(_that.selectedVideoPublication,_that.shouldNotifyNoVideoTrack,_that.sessionState,_that.isLoading,_that.errorMessage);case _:
  return null;
...
class _SignRecognitionState implements SignRecognitionState {
  const _SignRecognitionState({this.selectedVideoPublication, this.shouldNotifyNoVideoTrack = false, this.sessionState = SessionState.STOPPED, this.isLoading = false, this.errorMessage});
...
@override@JsonKey() final  SessionState sessionState;
...
/// Create a copy of SignRecognitionState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedVideoPublication = freezed,Object? shouldNotifyNoVideoTrack = null,Object? sessionState = null,Object? isLoading = null,Object? errorMessage = freezed,}) {
